...
import edu.brown.cs.ai.behavior.oomdp.planning.deterministc.informed.PrioritizedSearchNode.PSNComparator;
	...
	public void planFromState(State initialState) {
		...
		while(solutionNode == null){
			...
			if(solutionNode == null){
				System.out.println("Increase depth to F: " + nextMinR);
			}
