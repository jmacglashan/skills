...
public class EqualActionWeightedGreedy extends AStar {

	protected double costWeight;
	
	
	public EqualActionWeightedGreedy(Domain domain, RewardFunction rf, StateConditionTest gc, Map<String, List<Attribute>> attributesForHashCode, Heuristic heuristic, double costWeight) {
