...
import edu.brown.cs.ai.domain.oomdp.blockdude.Blockdude.AtExitPF;
import edu.brown.cs.ai.domain.oomdp.blockdude.Blockdude.EastAction;
import edu.brown.cs.ai.domain.oomdp.blockdude.Blockdude.HoldingBlockPF;
import edu.brown.cs.ai.domain.oomdp.blockdude.Blockdude.PickupAction;
import edu.brown.cs.ai.domain.oomdp.blockdude.Blockdude.PutdownAction;
import edu.brown.cs.ai.domain.oomdp.blockdude.Blockdude.UpAction;
import edu.brown.cs.ai.domain.oomdp.blockdude.Blockdude.WestAction;
...
public class BlockdudeMemReduced implements DomainGenerator {
	...
	public static int []								HEIGHTMAP = new int[MAXX+1];
	...
	public static void main(String[] args) {
		...
		BlockdudeMemReduced constructor = new BlockdudeMemReduced();
	...
	public static State getnCleanState(int nb){
		
		if(DOMAIN == null){
			(new BlockdudeMemReduced()).generateDomain();
		}
	...
	public static State getCleanState(List <Integer> platformX, List <Integer> platformH, int nb){
		...
		//start by setting platform heights
		clearHeightMap();
