...
public class BlockDudeExp {
	...
	public static Policy subgoalL2P1 = null;
	...
	public static void main(String[] args) {
		...
		for(int i = 0; i < n; i++){
			...
			//nwo += getNumWWeightedWOptions(0.1, 100000);
			nwo += getNumWDFSWOptions();
			//nwo += getNumWDFS();
		}
		
		System.out.println("Avg Num Visited: " + (double)nwo/(double)n);
	...
	public static void test3(String [] args){
		...
		//DeterministicPlanner dp = new DFS(d, rf, gc, attMap, -1, true, true);
		DeterministicPlanner dp = new ABRWeightedStates(d, rf, gc, attMap, new FixedPrimitiveOptionWeight(0.1, 100000));
		Policy p = new DDPlannerPolicy(dp);
	...
	public static int getNumWWeightedWOptions(double prim, double opt){
		...
		ActionBiasedRollout dp = new ABRWeightedStates(d, rf, gc, attMap, new FixedPrimitiveOptionWeight(prim, opt));
		...
		return dp.getNumVisited();
		
		
		
	}
	
	public static int getNumWDFSWOptions(){
		...
		DFS dp = new DFS(d, rf, gc, attMap, 84, false, false);
	...
	public static int getNumWDFS(){
		...
		DFS dp = new DFS(d, rf, gc, attMap, 110, false, false);
