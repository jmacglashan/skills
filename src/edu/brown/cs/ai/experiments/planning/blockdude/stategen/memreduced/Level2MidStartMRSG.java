...
public class Level2MidStartMRSG implements StateGenerator {

	State defaultState;
	
	public Level2MidStartMRSG(){
		...
		BlockdudeMemReduced.setAgent(s, 14, 3, 1, 0);
		BlockdudeMemReduced.setExit(s, 1, 0);
		
		BlockdudeMemReduced.setBlock(s, 0, 10, 0);
		BlockdudeMemReduced.setBlock(s, 1, 11, 1);
		BlockdudeMemReduced.setBlock(s, 2, 15, 3);
