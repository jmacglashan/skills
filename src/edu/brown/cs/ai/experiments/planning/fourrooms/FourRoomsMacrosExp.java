...
public class FourRoomsMacrosExp {
	...
	public static void main(String[] args) {
		...
		List <MacroAction> curMacros = exp.getNewMacroSequences(1, 11, 6, 9, 7, noMacros);
		System.out.println("------------------");
		curMacros.addAll(exp.getNewMacroSequences(1, 11, 9, 5, 8, curMacros));
		System.out.println("------------------");
		curMacros.addAll(exp.getNewMacroSequences(1, 11, 7, 1, 12, curMacros));
		
		//exp.getMacroActionsFor(1, 11, 9, 5, 14, noMacros);
	...
	public List <MacroAction> getNewMacroSequences(int ax, int ay, int gx, int gy, int depth, List<MacroAction> existingMacros){
		...
		List <MacroAction> res = AllSequenceExtraction.extractAllPrimtiveMacros(s, p, tf, "M" + existingMacros.size());
