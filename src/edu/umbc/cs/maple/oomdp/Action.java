...
public abstract class Action {
	...
	protected String []					parameterClasses_ = new String[0];		//list of class names for each parameter of the action
	protected String []					replacedClassNames_ = new String[0];	//list of class names to which each parameter object should be paramaterized
